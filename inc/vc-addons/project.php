...
add_shortcode( 'builder_project', function ( $atts, $content = null ) {
    ...
    $showall    = ( isset( $showall ) && '' != $showall ) ? $showall : __( "Show All", "builder-core" );
    ...
    if ( !empty( $terms ) && !is_wp_error( $terms ) ):
        ...
        $output .= '<ul>';
        $output .= '<li class="active" data-filter="*">' . esc_html( $showall ) . '</li>';
...
function builder_project() {
    ...
    vc_map( array(
        ...
        "params"   => array(
            ...
            array(
                "type"       => "textfield",
                "heading"    => __( "Show All Text", "builder-core" ),
                "param_name" => "showall",
                "group"      => "General",
            ),
            array(
